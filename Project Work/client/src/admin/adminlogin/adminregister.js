    ...
    return (
      ...
      <nav class = "navbar">
        ...
        <li type="button" class = "toggle-btn">
           <Link class="linkbar" to = '/admin-login'>SIGN IN</Link>
        </li>
        <li type="button" class = "toggle-btn">
           <Link class="linkbar" to = '/admin-register'>SIGN UP</Link>
        </li>
        </ul>
    </nav>
      ...
      <div className="base-container">
        ...
        <div style = {{marginLeft: 5, top: 5 ,textAlign:'center'}}>
           {IsError}
         </div>
          <div className="form">
          <div className="form-group">
            ...
            <div className="form-group">
             ...
             <div className="form-group">
              ...
              <input type="text" name="Mobile" value={Mobile}  placeholder="Mobile Number" onChange= {(e) => setMoblie(e.target.value)}/>
            </div>
           <div className="form-group">
