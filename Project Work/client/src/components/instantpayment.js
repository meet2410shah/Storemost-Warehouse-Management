    ...
    render() {
        return (
            ...
            <div class="container p-3 m-3 text-light">
                 <div class="row">
                     <div class="col-sm-2  text-right"> <img className= "img-fluid h-75 rounded-circle p-4 yup" src='/images/credit_score.png' alt='credit'></img></div>
                     <div className="col-sm-0 box"></div>
                     <div class="col-sm-8"> 
                         <h1 className="instant1">Instant Payment</h1>
                         <p className="text-secondary h5">Instantly request for space to store your crop into your wareshouse</p>
                    </div>
           ...
           <div className="container-fluid text-light">
            <form className="w-100">
                ...
                <div className="form-group row border-bottom ml-3 mr-5">
                 ...
                 <div className="col-sm-8">
                    <input type="text" className="form-control-plaintext text-light" value="Today"/>
                 </div>
                </div>
